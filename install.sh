...
"
echo -e "\033[31m"
echo -e "\033[32mWHATSAPP : 6295852103520\033[0m"
echo -e "\033[31mWEBSITE : https://t.me/Unixpublice"
echo ""

animate_text "ANDA SUDAH TERVERIFIKASI, SILAHKAN MASUKAN LICENSE YANG DI BAGI DARI FixsVaa"
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI FixsVaa, UNTUK HARGA 30K FREE UPDATE LICENSE"
animate_text " CONTACT FixsVaa: "
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${BLUE}[+]            ©COPYRIGHT BY FixsVaa      [+]${NC}"
  echo -e "${BLUE}[+]                                                [+]${NC}"
  echo -e "${BLUE}[+] ============================================== [+]${NC}"
echo ""
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
